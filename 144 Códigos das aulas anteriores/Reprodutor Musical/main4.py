...
from volume import Ui_MainWindow
...
class MainWindow(QMainWindow):
    ...
    def controlar_volume(self):
        volume = self.ui.horizontalSlider_Volume.value()  # Obtém o valor do slider
        self.player.setVolume(volume)  # Ajusta o volume do player
